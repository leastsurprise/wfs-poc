...
params = {'request': 'GetFeature', 'typeName': 'layer-50804', 'SRSName': 'EPSG:4167', 'cql_filter': 'title_no=95831', 'outputFormat': 'application/json'}
...
cql_filter_txt = 'WITHIN(shape,' + str(data.iloc[0]['geometry']) + ')'
